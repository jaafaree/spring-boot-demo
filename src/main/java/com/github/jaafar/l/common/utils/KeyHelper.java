package com.github.jaafar.l.common.utils;
...
public class KeyHelper {
    ...
    public void generateKey(String publicKeyFilename,String privateKeyFilename,String password) throws IOException, NoSuchAlgorithmException {
        ...
        fos.close();
        log.info("非对称加密密钥生成成功！");
        log.info("公钥生成路径：" + publicKeyFilename);
        log.info("私钥生成路径：" + privateKeyFilename);
    }

    public static void main(String[] args) throws IOException, NoSuchAlgorithmException {
        KeyHelper keyHelper = new KeyHelper();
        keyHelper.generateKey("H:\\spring-boot-test-demo\\src\\main\\resources/jwt/pub.key",
                    "H:\\spring-boot-test-demo\\src\\main\\resources/jwt/pri.key",
                "H90*&%^OIOj");
    }
    /**
     * 生存rsa公钥和密钥
